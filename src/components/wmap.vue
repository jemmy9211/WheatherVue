...
<template>
    ...
    <div class="container-fluid text-white shadow-lg p-1 bg-dark bg-opacity-50"><p class="text-white">全台觀測站位置圖<br>點按marker取得觀測站資料!</p></div>
  <div class="container p-4 shadow-lg border border-3">
